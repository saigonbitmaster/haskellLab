...
/* package cardanoLab-0.1.0.0 */
#ifndef VERSION_cardanoLab
#define VERSION_cardanoLab "0.1.0.0"
#endif /* VERSION_cardanoLab */
#ifndef MIN_VERSION_cardanoLab
#define MIN_VERSION_cardanoLab(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cardanoLab */
...
#define CURRENT_COMPONENT_ID "cardanoLab-0.1.0.0-inplace-cardanoLab"
